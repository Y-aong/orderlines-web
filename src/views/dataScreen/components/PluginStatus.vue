...
watch(props, () => {
  option.value = {
    ...
    legend: {
      ...
      data: props.data.map((val: ChartProp) => val.name)
    },
    series: [
      {
        type: "pie",
...
// const data = [
//   { value: 40, name: "插件A", percentage: "40%" },
//   { value: 10, name: "插件B", percentage: "10%" },
//   { value: 20, name: "插件C", percentage: "20%" },
//   { value: 30, name: "插件D", percentage: "30%" }
// ];
</script>
