    ...
    >
      ...
      <el-form-item label="jenkins参数" prop="parameter" clearable>
        <el-table :data="drawerProps.row!.parameter" show-header size="small" align="center" border style="width: 100%">
          <el-table-column prop="param_name" label="名称" min-width="50" show-overflow-tooltip />
      ...
      <el-form-item label="jenkins颜色" prop="color" clearable>
        <el-input v-model="drawerProps.row!.color" placeholder="请填写jenkins颜色" clearable></el-input>
      </el-form-item>
