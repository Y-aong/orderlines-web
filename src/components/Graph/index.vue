...
import { getPCNextNodeOptionRequest } from "@/api/option/index";
import {
...
export default {
  ...
  methods: {
    ...
    async handleProcessControl(data) {
      const response = await getPCNextNodeOptionRequest(data.id, process_id.value);
