...
// 修改流程参数
export const updateProcessParamRequest = (params: Process.ProcessParam, process_id: string) =>
...
// 创建流程版本
export const createProcessVersionRequest = (data: GraphOperator.ProcessVersionType) =>
...
export const getSetupTearDownParamRequest = (name: string) =>
  http.get<Process.ProcessParam>(`${API.SETUP_TEARDOWN_PARAM}?name=${name}`);
